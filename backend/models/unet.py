...
class UNet(nn.Module):
    ...
    Detects deforestation, land cover changes, and pollution zones
    """
    def __init__(self, n_channels=3, n_classes=4, bilinear=False):
        """
        Args:
            n_channels: Number of input channels (3 for RGB satellite images)
...
def test_model():
    ...
    # Test with dummy input (batch_size=2, channels=3, height=256, width=256)
    ...
    print(f"📦 Expected shape: [batch_size=2, n_classes=4, height=256, width=256]")
